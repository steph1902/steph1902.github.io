document.addEventListener('DOMContentLoaded', function() {
    const translations = {
        en: {
            ...
            summary_p3: '<strong>Seeking:</strong> Senior full-stack engineering roles with innovative product companies in USD/EUR markets, where I can leverage my technical leadership and 0-to-1 product development expertise.',
            ...
            experience_job1_li1: 'Led 25+ end-to-end DX projects (0→1), transforming paper-based workflows into complete digital systems using Next.js and Laravel, reducing manual data entry time by 70-85% across client organizations.',
        ...
        jp: {
            ...
            summary_p3: '<strong>希望職種：</strong>USD/EUR市場の革新的な製品企業でのシニアフルスタックエンジニアリングの役割。技術的リーダーシップと0から1への製品開発の専門知識を活用できる環境を求めています。',
            skills_title: '技術スキル',
