document.addEventListener('DOMContentLoaded', function() {
    const translations = {
        en: {
            ...
            header_location: 'Tangerang, Banten, Indonesia',
            summary_title: 'Professional Summary',
            summary_p1: 'Full-stack engineer with 9 years of experience in web application development, team leadership, and technical architecture. Co-founded PT. ARUNIKA GLOBAL KREATIF in 2019 and scaled the engineering organization from 2 to 30 people. Delivered 30+ web applications across SaaS, fintech, e-commerce, and government sectors. Strong expertise in React, Next.js, Node.js, PostgreSQL, and AWS.',
            summary_p2: '<strong>Core expertise:</strong> Building high-performance systems, leading technical teams, and managing complex projects from concept to production. Proven track record in full-stack architecture, cloud infrastructure (AWS), performance optimization (consistently achieving 90+ Lighthouse scores), and bridging business-technology strategy. Experienced in remote collaboration with international teams across multiple time zones.',
        ...
        jp: {
            ...
            header_location: 'タンゲラン、バンテン、インドネシア',
            summary_title: '職務経歴の概要',
            summary_p1: 'Webアプリケーション開発、チームリーダーシップ、技術アーキテクチャにおいて9年の経験を持つフルスタックエンジニア。2019年にPT. ARUNIKA GLOBAL KREATIFを共同設立し、エンジニアリング組織を2人から30人に拡大。SaaS、フィンテック、EC、政府部門で30以上のWebアプリケーションを提供。React、Next.js、Node.js、PostgreSQL、AWSに精通。',
            summary_p2: '<strong>コア専門知識：</strong>高性能システムの構築、技術チームのリーダーシップ、コンセプトから本番までの複雑なプロジェクト管理。フルスタックアーキテクチャ、クラウドインフラストラクチャ（AWS）、パフォーマンス最適化（一貫して90以上のLighthouseスコアを達成）、ビジネステクノロジー戦略の橋渡しの実績。複数のタイムゾーンにわたる国際チームとのリモートコラボレーション経験。',
            skills_title: '技術スキル',
